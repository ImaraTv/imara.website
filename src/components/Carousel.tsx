...
export function CarouselHome() {
    return (
        ...
        >
                ...
                <SwiperSlide key={item.id}>
                    ...
                    <div className="absolute z-[999] text-white bottom-[64px] ltr:left-12 rtl:right-12 px-12">
                        ...
                        <div className="flex gap-10 mt-[43px]">
                            <Link
                                href="/sign-in"
                                className="group inline-flex bg-[#007BFF] items-center justify-center rounded-lg py-2 px-10 text-[17px] font-medium text-white focus:outline-none"
                            >
                                Watch Now
                            </Link>
                            <Link
                                href="/sign-in"
                                className="group inline-flex gap-3 items-center justify-center rounded-lg py-2 px-10 text-[17px] font-medium text-white focus:outline-none"
                            >
            ...
            <button
                className="swiper-button-prev-ex4 grid place-content-center ltr:left-2 rtl:right-2 p-2 transition text-primary hover:text-white border border-primary  hover:border-primary hover:bg-primary rounded-lg absolute z-[999] bottom-[60px] right-20 -translate-y-1/2">
            ...
            <button
                className="swiper-button-next-ex4 grid place-content-center ltr:right-2 rtl:left-2 p-2 transition text-primary hover:text-white border border-primary  hover:border-primary hover:bg-primary rounded-lg absolute z-[999] bottom-[60px] right-10 -translate-y-1/2">
