        ...
        >
          ...
          >
            ...
            <div className="flex gap-2">
              <MobileNavLink href="https://dashboard.imara.tv/admin/register?r=creator">
                Create on Imara
              </MobileNavLink>
        ...
        <div className="hidden items-center md:flex md:gap-x-4">
          ...
          <div className="hidden md:flex md:gap-x-6">
            ...
            <Popover className="relative">
              <Popover.Button className="inline-flex items-center gap-x-1 rounded-lg px-2 py-1 text-lg font-bold text-[#525252] hover:bg-slate-100 hover:text-slate-900">
