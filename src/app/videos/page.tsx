...
export default function Videos() {
  ...
  return (
    <>
      ...
      <main>
        <Container>
          <div className='font-bold text-[40px] text-[#2B2B2B] mt-14'>All our videos</div>
              ...
              <div className="">
                <Listbox value={selected} onChange={setSelected}>
                  <div className="relative mt-1">
                    <Listbox.Button className="relative inline-flex mr-2 items-center gap-x-2 rounded-md bg-white px-6 py-2 text-[17px] font-medium text-[#525252] shadow-sm ring-1 ring-inset ring-[#525252] hover:bg-gray-50">
          ...
          <div className='flex justify-between mt-[90px]'>
            <div>
              <ul role="list" className="grid grid-cols-2 gap-x-4 gap-y-[100px] sm:grid-cols-3 sm:gap-x-6 lg:grid-cols-3 xl:gap-x-8">
                {files.map((file) => (
                  <li key={file.title} className="relative">
                    <div onClick={openModal} className="group aspect-h-7 aspect-w-10 block w-full overflow-hidden rounded-lg bg-gray-100 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 focus-within:ring-offset-gray-100">
                ...
                <Dialog as="div" className="relative z-10" onClose={closeModal}>
                  ...
                  <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                      ...
                      >
                        <Dialog.Panel className="w-[342px] h-auto max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                          <Dialog.Title
                            as="h3"
                          ...
                          <div className='flex gap-1 items-center mt-[55px] mb-[27px]'>
                            <div className='font-bold text-[20px] text-[#525252]'>Category:</div>
                            <div className='font-medium text-[17px] text-[#525252]'>GBV awareness</div>
                          </div>
                          <div className="mt-2">
            ...
            <div>
              <ul role="list" className="-mt-12 space-y-12 xl:col-span-3">
                {suggestions.map((suggestion) => (
                  <li key={suggestion.name} className="flex flex-col gap-10 pt-12 sm:flex-row items-center justify-center">
          ...
          <div className='flex items-center justify-center gap-8 mt-[112px] mb-[223px]'>
            ...
            <div className='flex items-center justify-center p-4 bg-[#0000002E] font-semibold text-[15px] text-white'>6</div>
            <div className='flex items-center justify-center p-4 bg-[#0000002E] font-semibold text-[15px] text-white'>7</div>
          </div>
