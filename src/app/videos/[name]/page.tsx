    ...
    <>
      ...
      <main>
        ...
        <Container>
          {/* Video details */}
          {isLoading ? (
              <div className="flex justify-between space-x-10 my-[58px]">
                  <div
                    role="status"
                    className="w-1/2 flex gap-10 animate-pulse rounded border border-gray-200 p-4 shadow dark:border-gray-700 md:p-6"
                  >
                    <div className="mb-4 flex w-60 h-60 items-center justify-center rounded bg-gray-300 dark:bg-gray-700">
                      <svg
                ...
                <div
                  className="flex animate-pulse h-12 w-36 items-center justify-center gap-2 rounded bg-gray-300 dark:bg-gray-700 px-4"
                  style={cardStyle}
                >
                </div>
              </div>
